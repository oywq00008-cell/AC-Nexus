...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'acnexus_desktop.pyside.brand_dialog','acnexus_desktop.pyside.xiaomi_login_dialog','acnexus_desktop.pyside.xiaomi_device_picker','schedule','python-miio','qrcode','Pillow',
