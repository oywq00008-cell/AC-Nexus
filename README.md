...
**AC-Nexus 是一套运行在电脑上的智能空调控制中枢。** 用一台电脑（Windows / macOS / Linux）就能集中管理家里或办公室里的空调，把博联、米家等红外遥控器统一到一个界面里控制。

它同时支持两类红外遥控设备：

- **博联 Broadlink RM 系列**（RM4 mini / RM Pro 等）
- **米家 Xiaomi MIoT** 红外遥控器（空调伴侣 / 万能遥控器）

**能做什么？**
- 🖱️ 手动控制：开关、模式、温度、风量一键搞定
- 🌡️ 自动调温：按室外温度自动调整，冬暖夏凉不用管
- ⏰ 定时开关：工作日 / 周末多组模板自由排
- 🌪️ 风暴保护：台风临近自动关机保护外机（全网独家）
- 🌐 跨平台 + 开源：全平台运行，MIT 协议免费使用
